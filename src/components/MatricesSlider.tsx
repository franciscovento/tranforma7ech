...
const MatricesSlider = () => {
  return (
    <div className="px-12 web-container">
        ...
        <SwiperSlide>
          <div className="flex flex-col items-center justify-center gap-8">
            <h3 className="uppercase text-tt-blue text-2xl font-bold flex flex-col items-center justify-center gap-4 text-center">
              ...
              Matriz de Datos y Aplicaciones
            </h3>
            <img src="/matriz-datos-aplicaciones.png" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <img src="/matriz-tecnologica.png" />
          </div>
        </SwiperSlide>
        <div className="py-8">
          <NextSlide />
